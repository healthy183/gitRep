...
import com.kang.shiro.myShiroRealmJDBC.permissionService.impl.PermissionServiceImpl;
import com.kang.shiro.myShiroRealmJDBC.roleService.IroleService;
import com.kang.shiro.myShiroRealmJDBC.roleService.impl.RoleServiceImpl;
...
public class BaseTest {
    ...
    protected Role r1;
    protected Role r2;
    protected UserModel u1;
    protected UserModel u2;
    protected UserModel u3;
    protected UserModel u4;
    ...
    public void setUp(){
         ...
         //4、new user
         u1 = new UserModel("zhang", password);
         u2 = new UserModel("li", password);
         u3 = new UserModel("wu", password);
         u4 = new UserModel("wang", password);
         u4.setIsLocked(Boolean.TRUE);
         userService.createUser(u1);
         userService.createUser(u2);
         userService.createUser(u3);
         userService.createUser(u4);
         //5、关联用户-角色
         userService.correlationRoles(u1.getUserId(), r1.getId());
