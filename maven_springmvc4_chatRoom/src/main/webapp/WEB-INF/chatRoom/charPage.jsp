...
<body>
    ...
    <script type="text/javascript">
        $(function() {
            var msgBox = $("#msg-box");
            var pollUrl = "${pageContext.request.contextPath}/chat.html?command=poll&username=${param.username}";
            var chat = {
            ...
            $("#send-btn").click(function() {
                ...
                $.get("${pageContext.request.contextPath}/chat.html?command=send&receiver="+receiver + "&msg=" + msg);
            });
