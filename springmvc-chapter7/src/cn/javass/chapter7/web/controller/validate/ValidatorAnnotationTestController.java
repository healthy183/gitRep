...
public class ValidatorAnnotationTestController {
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/AssertFalse?value=true
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/AssertTrue?value=false
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/notNull
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/null?value=123
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/min?value=9
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/max?value=101
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/decimalMin?value=9
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/decimalMax?value=101
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/digits?value=912211.23(整数位超长)
	 * http://localhost:8080/springmvc-chapter7/validate/digits?value=12.232(小数位超长)
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/past?date=2112-10-10
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/future?date=2002-10-10
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/notBlank  (没有值 即value=null)
	 * http://localhost:8080/springmvc-chapter7/validate/notBlank?value=    (value是空字符串)
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/length?value=1  (下限最小是2)
	 * http://localhost:8080/springmvc-chapter7/validate/length?value=12345678901  (上限最大是10)
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/notEmpty?array=1 (value字符串为空)
	 * http://localhost:8080/springmvc-chapter7/validate/notEmpty?value=123 (array数组为空)
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/range?value=1   (数字的最小值是2)
	 * http://localhost:8080/springmvc-chapter7/validate/range?value=11  (数字的最大值是10)
	 * 
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/email?value=zhang.com
	 * 
	 * 输入如下地址将验证成功
	 * http://localhost:8080/springmvc-chapter7/validate/email?value=zhang@gmail.com 
	 * 
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/pattern?value=zhan  (长度在5-20之间	)
	 * http://localhost:8080/springmvc-chapter7/validate/pattern?value=7aa (不能以数字开头) 
	 * 
	 */
	 ...
	 * 
	 * 输入如下地址将验证失败
	 * http://localhost:8080/springmvc-chapter7/validate/recursionValid?r1.value=1   (r1对象的value长度必须在2-10之间)

	 * 输入如下地址将验证成功
	 * http://localhost:8080/springmvc-chapter7/validate/recursionValid?r1.value=123  
	 * 
	 * r2对象不会进行递归参与验证
	 * 
	 */
