...
phoneNumber:<spring:bind path="dataBinderTest.phoneNumber">${status.value}</spring:bind>
<!-- 如果没有配置org.springframework.web.servlet.handler.ConversionServiceExposingInterceptor将会报错 -->
phoneNumber:<spring:eval expression="dataBinderTest.phoneNumber"></spring:eval>
